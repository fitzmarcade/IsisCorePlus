...
WHERE entryorguid='190000' AND event_param1 = '50000';
...
('50000', @SMALL, '2', 'New teleport', 1, 1, '50000', '0', 'Are you sure?');
...
('190000', 0, IFNULL(@SID, 1), 0, 62, 0, 100, 0, '50000', @SMALL, 0, 0, 62, '0', 0, 0, 0, 0, 0, 0, 8, 0, 0, '1679.155762', '-5351.141113', '74.093506', '4.651279', 'Teleporter script - Custom');
